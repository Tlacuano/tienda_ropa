                            ...
                            <b-row no-gutters>
                                ...
                                <b-col lg="11">
                                    <b-row align-v="center" class="h-100 ">
                                        ...
                                        <b-col>
                                            <div>
                                                <h6 class="mb-1" style="display: inline-block;">Precio: </h6><p class="mb-1" style="display: inline-block; margin-left: 5px;">{{ product.productPrice }}</p>
                                            </div>
                                            <div>
                                                <h6 class="mb-1" style="display: inline-block;">Disponibles: </h6><p class="mb-1" style="display: inline-block; margin-left: 5px;">{{ product.productStock}}</p>  
                                            </div>                                            
                                        </b-col>                    
                                        <b-col>
                                            <div>
                                                <h6 class="mb-1" style="display: inline-block;">Tallas: </h6><p class="mb-1" style="display: inline-block; margin-left: 5px;">{{ product.productSize }}</p>
                                            </div>
                                            <div>
                                                <h6 class="mb-1" style="display: inline-block;">Precio: </h6><p class="mb-1" style="display: inline-block; margin-left: 5px;">{{ product.productPrice }}</p>                                          
                                            </div>                                                                                        
                                        ...
                                        <b-col cols="auto">
                                            <b-badge
                                                variant="success"
                                                class="mb-1"
                                                v-if="product.productStatus === 'habilidato'"
                                            >
                                            </b-badge>
                                            <b-badge
                                                variant="danger"
                                        ...
                                        <b-col cols="auto">
                                            <b-button variant="outline-dark" class="mb-1">Editar</b-button>
