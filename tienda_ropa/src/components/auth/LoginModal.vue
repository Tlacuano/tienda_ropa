    ...
    <b-modal id="login" title="Iniciar sesión" hide-footer centered >
      <b-container fluid>
        <b-row>
          <b-col>
            <b-form>
              <b-form-group label="Correo electrónico" laber-for="email">
                <b-form-input
                  id="email"
              ...
              <b-form-group class="custom-form-group">
                <b-link @click="forgotPassword" class="custom-link">¿Haz olvidado tu contraseña?</b-link>
              </b-form-group>
              <b-button type="submit" variant="dark" block>Iniciar sesión</b-button>
            </b-form>
          </b-col>
        </b-row>
        <b-row class="mt-2 custom-form-group">
          <b-col>
              ¿No tienes una cuenta? <b-link @click="redirectSignUp" class="custom-link"> <strong>Registrate</strong> </b-link>
          </b-col>
        </b-row>
